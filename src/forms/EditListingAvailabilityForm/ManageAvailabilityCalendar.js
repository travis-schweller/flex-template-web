...
const renderDayContents = (calendar, availabilityPlan) => date => {
  // This component is for day/night based processes: monthIdStringInUTC
  // If time-based process is used, you might want to deal with local dates with monthIdString
